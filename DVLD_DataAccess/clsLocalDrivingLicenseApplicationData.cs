     ...
     int ApplicationID, int LicenseClassID)
        {
            ...
            try
            {
                ...
                if (result != null && int.TryParse(result.ToString(), out LocalApp))
                {
                    LocalDrivingLicenseApplicationID = LocalApp;
                }
...

        {
            ...
            try
            {
                ...
                if (result != null && bool.TryParse(result.ToString(), out  returnedResult))
                {
...

        {
            ...
            try
            {
                ...
                object result = command.ExecuteScalar();
                byte Trials = 0;
                if (result != null && byte.TryParse(result.ToString(), out  Trials))
                {

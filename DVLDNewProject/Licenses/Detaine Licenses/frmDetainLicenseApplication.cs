...
namespace DVLDNewProject.Licenses.Detaine_Licenses
{
    public partial class frmDetainLicenseApplication : Form
    {
        ...
        private void ctrDriverLicenseInfoWithFliter1_OnLicenseSeleted(int obj)
        {
            ...
            if (ctrDriverLicenseInfoWithFliter1.SelectedLicenseInfo.IsDetained)
            {
        ...
        private void btnDetain_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are you sure, you want to Detain this License", "Confierm", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.No)
            {
                return; 
            }


            _DetainID = ctrDriverLicenseInfoWithFliter1.SelectedLicenseInfo.Detain(Convert.ToSingle(txtFineFees.Text.Trim()), clsGlobal.CurrentUser.UserID);
        ...
        {
            frmShowLicenseInfo frm = new frmShowLicenseInfo(this._SelectedLicenseID);
            frm.ShowDialog();
        }

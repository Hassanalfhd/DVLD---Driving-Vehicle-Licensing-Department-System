...
namespace DVLDNewProject.Tests
{
    public partial class frmTakeTest : Form
    {
        ...
        {
            if (MessageBox.Show("Are you sure you want to save? After that you cannot change the Pass/Fial results after you save?.",
                "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == System.Windows.Forms.DialogResult.No)
                return;
